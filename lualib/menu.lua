...
function _M.draw()
    ...
    if _M.mode == MODE_MAIN_MENU then
        ...
        oledDrawRect(112, 1, 13, 13, 1)
        oledDrawRect(112, 16, 13, 13, 1)
        oledDrawRect(112, 33, 13, 13, 1)

        oledDrawIcon(113, 16, _M.settings_icon)
        oledDrawIcon(113, 32, _M.settings_icon)
